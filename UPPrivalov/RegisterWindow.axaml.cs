...
public partial class RegisterWindow : Window
{
    ...
    private void Register(object? sender, RoutedEventArgs e)
    {
        ...
        {
            MySqlCommand command = new MySqlCommand("INSERT INTO sql12659906.Students (Name, Surname, LastName, Birthday, Phone_Number, Email, Language_Experience,Language_Level, Login, Password)" +
